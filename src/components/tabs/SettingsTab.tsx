        ...
        <section className="bg-dark-card border border-slate-700/50 rounded-2xl overflow-hidden">
          ...
          <div className="p-5 space-y-3">
            <div className="bg-slate-800/50 rounded-xl p-4">
              <div className="text-slate-300 text-sm font-medium mb-1">Anthropic API 키</div>
              <div className="text-slate-500 text-xs">
                API 키는 서버 환경 변수에서 관리됩니다.{' '}
                <code className="bg-slate-700 px-1 py-0.5 rounded text-slate-300">ANTHROPIC_API_KEY</code>{' '}
                환경 변수를 설정하세요.
              </div>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-4">
              ...
              <div className="text-slate-500 text-xs mt-1">진료 내용 분석 및 요약에 사용됩니다</div>
            </div>
          </div>
        </section>
